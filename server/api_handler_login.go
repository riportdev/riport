...
func (al *APIListener) handleGetLogin(w http.ResponseWriter, req *http.Request) {
	...
	// TODO: consider to move this check from all API endpoints to middleware similar to https://github.com/riportdev/riport/pull/199/commits/4ca1ca9f56c557762d79a60ffc96d2de47f3133c

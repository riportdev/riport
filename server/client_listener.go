...
import (
	...
	"github.com/riportdev/riport/plus/capabilities/alerting/transformers"
	"github.com/riportdev/riport/server/api/middleware"
...
func (cl *ClientListener) handleClient(w http.ResponseWriter, r *http.Request) {
	...
	// websockets upgrade AND has riport prefix
	upgrade := strings.ToLower(r.Header.Get("Upgrade"))
	protocol := r.Header.Get("Sec-WebSocket-Protocol")
	if upgrade == "websocket" && strings.HasPrefix(protocol, "riport-") {

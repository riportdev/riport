...
var (
	...
	ErrCaddyUnknownLogLevel                     = errors.New("riport log level not a known caddy log level")
...
type Config struct {
	...
	LogLevel         string `mapstructure:"-"` // taken from the riport server log level
	DataDir          string `mapstructure:"-"` // taken from the riport server datadir

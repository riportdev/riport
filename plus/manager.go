...
import (
	...
	"github.com/riportdev/riport/plus/loader"
...
var (
	ErrPlusNotAvailable       = errors.New("riport-plus not enabled/available")
	ErrCapabilityNotAvailable = func(capName string) error { return fmt.Errorf("riport-plus capability (%s) not available", capName) }
)

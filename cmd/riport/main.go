...
import (
	...
	"github.com/riportdev/riport/cmd/riport/servicemanagement"

	"github.com/kardianos/service"
	"github.com/spf13/cobra"

	"github.com/riportdev/riport/cmd/riport/cli"
...
func runMain(*cobra.Command, []string) {
	...
	if serviceManager {
		...
		if err := runClient(pFlags); err != nil { // app run as riport client
			log.Fatal(err)
		}
	}
}
